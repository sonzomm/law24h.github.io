...
class SiteController extends Controller {
    ...
    public function gioithieu(){
        $pageTitle = 'Gioithieu';
        return view($this->activeTemplate.'gioithieu',compact('pageTitle'));
    }
    ...
    public function sendBookingRequest(Request $request) {
        ...
        $notify[] = ['success', 'Yêu cầu đặt phòng được gửi thành công'];
    ...
    public function checkRoomAvailability(Request $request) {
        ...
        if (!$availableRoom) {
            return response()->json(['error' => 'Không còn phòng trống giữa những ngày này']);
        }
