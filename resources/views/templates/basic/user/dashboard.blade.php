    ...
    <div class="row gy-4 pb-3">
        ...
        <div class="col-xxl-4 col-xs-6">
            <div class="widget widget--primary">
                ...
                <div class="widget__body">
                    <h6 class="widget__title"> @lang('Đang yêu cầu')</h6>
        ...
        <div class="col-xxl-4 col-xs-6">
            <div class="widget widget--success">
                ...
                <div class="widget__body">
                    <h6 class="widget__title"> @lang('Thành công')</h6>
        ...
        <div class="col-xxl-4 col-xs-6">
            <div class="widget widget--danger">
                ...
                <div class="widget__body">
                    <h6 class="widget__title"> @lang('Hủy')</h6>
        ...
        <div class="col-xxl-4 col-xs-6">
            <div class="widget widget--dark">
                ...
                <div class="widget__body">
                    ...
                    <h3 class="widget__amount">{{showAmount($booking['total_payment']).$general->cur_sym  }}</h3>
                </div>
            </div>
        </div>
    </div>

    <h5 class="text--secondary my-3">@lang('Bookings gần đây')</h5>
