...
@section('panel')
    <div class="notify__area">
        @forelse($notifications as $notification)
            <a class="notify__item @if ($notification->is_read == \App\Constants\Status::NO) unread--notification @endif" href="@if (can('admin.notification.read')) {{ route('admin.notification.read', $notification->id) }} @else javascript:void(0) @endif">
