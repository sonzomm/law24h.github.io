        ...
        <div class="container custom-container d-flex justify-content-center">
            <div class="login-area">
                <div class="text-center mb-3">
                    <h2 class="text-white mb-2">@lang('Xác minh')</h2>
                    <p class="text-white mb-2">@lang('Vui lòng kiểm tra email của bạn và nhập mã xác minh bạn nhận được trong email của mình.')</p>
                </div>
                <form action="{{ route('admin.password.verify.code') }}" method="POST" class="login-form w-100">
                    ...
                    <div class="code-box-wrapper d-flex w-100">
                        <div class="form-group mb-3 flex-fill">
                            <span class="text-white fw-bold">@lang('Xác minh')</span>
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <a href="{{ route('admin.password.reset') }}" class="forget-text">@lang('Thử gửi lại')</a>
                    </div>
