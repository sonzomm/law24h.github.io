                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        <div class="card border--primary mt-3">
                                            <h5 class="card-header bg--primary">@lang('')</h5>
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label>@lang('Số tiền tối thiểu')</label>
                                                ...
                                                <div class="form-group">
                                                    <label>@lang('Số tiền tối đa')</label>
                                                    <div class="input-group">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        <div class="card border--primary mt-3">
                                            <h5 class="card-header bg--primary">@lang('Phụ phí')</h5>
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label>@lang('phí %')</label>
                                                    <div class="input-group">
                                    ...
                                    <div class="col-12">
                                        <div class="card border--primary mt-3">
                                            <h5 class="card-header bg--primary">@lang('Hướng dẫn')</h5>
                                            <div class="card-body">
                                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border--primary mt-3">
                                            <div class="card-header bg--primary d-flex justify-content-between">
                                                <h5 class="text-white">@lang('Form')</h5>
                                                <button class="btn btn-sm btn-outline-light float-end form-generate-btn" type="button"> <i class="la la-fw la-plus"></i>@lang('Thêm')</button>
                                            </div>
                                            <div class="card-body">
