                    ...
                    <div class="card">
                        <div class="card-body">
                            @if ($due < 0)
                                ...
                                <h5 class="text--danger text-center">@lang('Số tiền được hoàn lại'): {{ $general->cur_sym }}{{ showAmount(abs($due)) }}</h5>
                            @else
                                <h5 class="card-title"> @lang('Nhận thanh toán')</h5>
                                <h5 class="text-center text--success"> @lang('Số tiền phải thu'): {{ $general->cur_sym }}{{ showAmount(abs($due)) }}</h5>
                            @endif
