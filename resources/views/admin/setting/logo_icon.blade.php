                                ...
                                <div class="image-upload">
                                    <div class="thumb">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <label for="profilePicUpload1" class="bg--primary">@lang('Chọn Logo')</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
